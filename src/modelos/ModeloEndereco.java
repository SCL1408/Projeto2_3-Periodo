...
public class ModeloEndereco {
    ...
    public ModeloEndereco(int idEndereco, String logradouro, int numero, String complemento, String bairro, String cidade, String estado) {
    ...
    public void setIdEstado(int idEndereco){
        this.idEndereco = idEndereco;
    }
